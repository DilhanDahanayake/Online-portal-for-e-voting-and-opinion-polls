        ...
        <div class="container">
            <div class="text-txt">
                <div class="right-side text-center">
                    <h4>Vote Yourself</h4>
                    <a class="btn button-style mt-4" href="<?php echo base_url(); ?>/home/dashboard">Get Started<i
...
<script src="<?php echo base_url(); ?>libraries/frontend/assets/js/jquery-3.3.1.min.js"></script>
<!-- //common jquery plugin -->

<!-- theme switch js (light and dark)-->
<script src="<?php echo base_url(); ?>libraries/frontend/assets/js/theme-change.js"></script>
<script>
...
<!-- magnific popup -->
<script src="<?php echo base_url(); ?>libraries/frontend/assets/js/jquery.magnific-popup.min.js"></script>
<script>
    $(document).ready(function () {
...
<script src="<?php echo base_url(); ?>libraries/frontend/assets/js/owl.carousel.js"></script>
<script>
    $(document).ready(function () {
...
<!--bootstrap-->
<script src="<?php echo base_url(); ?>libraries/frontend/assets/js/bootstrap.min.js"></script>
<!-- //bootstrap-->
<!-- //Js scripts -->
</body>
